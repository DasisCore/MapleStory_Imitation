...
void CDamegeFactory::CreateSingleDamege(CObject* _pObj, int _iDamege, float _fOffset, DAMEGE_TYPE _eDamegeType)
{
	...
	pDamege->SetPos(Vec2(vPos.x, vPos.y - (vScale.y / 2.f) - _fOffset));
